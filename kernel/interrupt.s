...
handler_rst: bl    table_copy              @ initialise interrupt vector table
             ...
             msr   cpsr, #0xD3             @ enter IRQ mode with no interrupts -- should this be that ? 
...
table_copy:  mov   r0, #0                  @ set destination address
             ...
             ldr   r2, =table_copy         @ set source      limit  -- address of table copy in r2

table_loop:  ldr   r3, [ r1 ], #4          @ load  word, inc. source      address -- 4 in bytes = word => undefined inst
